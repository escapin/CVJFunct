...
public class Main {
	...
	/*
	 * This class accepts path to a java file or folder and will do following steps:
	 * 1. It will generate interface IE (using class InterfaceGenerator)
	 * 2. It will validate the generated interface to comply with the conditions from Appendix D.A (and abort in case of violation)
	 * 3. It will generate the System E to the output file
	 * 
	 * Usage: 	Parameter 1 = 	Path to source file or Folder, all .java files will be accepted
	 * 			Parameter 2 = 	Path to output folder - Source code of System E will be stored here
	 * 			Parameter 3 = 	Validation rules allow to specify "accepted classes". Optionally a file containing a comma separated list of
	 * 							classes goes here. (fully specified class names like 'java.util.HashMap' except 'java.lang' package, here 
	 * 							only use classname like 'String')
	 * 
	 * Notes:	- For optimal class recognition do not use wildcard-imports (java.util.*) but fully qualified imports (java.util.HashMap)
	 * 			- Classes must not extend imported classes but only ones from IE
	 *
	 * TODO:	- If code contains constructor, just leave it out from IE or generate IE and fail on verification?
	 * 			- Accept all primitive types (float, long,...) or only byte, byte[], void and int?
	 * 
	 */
	public static void main(String[] args) throws Exception {
		if (args.length < 2) {
			System.out.println("Missing parameter\nUsage: <path-to-file/folder IN> <path-to-output-file> [<path-to-accepted-types-list>]");
			return;
		}
	...
	public void doWork(String pathIn, String fileOut, String acceptedTypes) throws Exception{
