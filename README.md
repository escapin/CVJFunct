...
The most interesting feature of this implementation is that for each (real) cryptographic functionality, there exists a corresponding ideal version (see branch `ideal`) in such a way that the real *realizes* the ideal in the spirit of simulation-based security.  See, for instance:
- Canetti R.,
