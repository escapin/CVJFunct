...
public class SigningKey {
	...
	public SigningKey(RSAPrivateKey privateKey) {
		this.privateKey = privateKey;
	}
	
	public SigningKey(Message m) throws CryptoException {
		if (m.getTag() != Message.TAG_KEY) {
			throw new CryptoException("Message seems not to be a valid SigningKey - Wrong TAG!");
		}
